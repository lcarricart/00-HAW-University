...
public class FrontBody {
	...
	public void drawAt(int left, int bottom) {
		double radiusFrontBody = size / 2;

		double xShiftBackBody = size / 4;
		double yShiftBackBody = size / 7;

		double xShiftLeg1 = size / 6;
		double xShiftLeg2 = xShiftLeg1 + size / 6;
		double yShiftLeg = size / 3;
