...
public class BackBody 
{
	...
	public void drawAt(double left, double bottom) {
		...
		Drawing.getPen().drawOval((int)left, (int)bottom, (int)(width), (int)(heightBackBody));
		Drawing.getPen().fillOval((int)left, (int)bottom, (int)(width), (int)(heightBackBody));
		
		leg3.drawAt((int) (left + xShiftLeg1), (int) (bottom + yShiftLeg));
		leg4.drawAt((int) (left + xShiftLeg2), (int) (bottom + yShiftLeg));
		dogFur.draw((int) left, (int) bottom, width, heightBackBody, shape);
