...
import gui.ConfigurationJPanel.EnumGlasses;
import gui.ConfigurationJPanel.EnumHat;
import gui.ConfigurationJPanel.EnumColor;
...
public class Ground {
    ...
    private EnumGlasses gKind;
    private EnumHat hKind;
    private EnumColor cKind;
    ...
    public void generateRandomPuddles() {
        ...
        while (notMaxAmount(goodPuddles) && notMaxAttempts(attempts)) {
            ...
            if (randomizeGlasses == true) { // RANDOM case
            	glassesKind = RandomNumber.between(0, 2);
            }
            if (randomizeHat == true) { // RANDOM case
