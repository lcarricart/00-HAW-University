...
public class FrontBody {
	...
	public FrontBody(double lenght, Fur dogFur, Glasses myGlasses, Hat myHat) {
		double sizeHead = lenght / 2;
		double sizeLeg = lenght / 3;
		this.lenght = lenght;
		this.dogFur = dogFur;
		...
		leg1 = new Leg(sizeLeg, dogFur);
		leg2 = new Leg(sizeLeg, dogFur);
		dogHead = new Head(sizeHead, myGlasses, myHat);
	}
	
	public FrontBody(double lenght, Fur dogFur, Hat myHat) {
		double sizeHead = lenght / 2;
		double sizeLeg = lenght / 3;
		this.lenght = lenght;
		this.dogFur = dogFur;
		...
		leg1 = new Leg(sizeLeg, dogFur);
		leg2 = new Leg(sizeLeg, dogFur);
		dogHead = new Head(sizeHead, myHat);
	}
